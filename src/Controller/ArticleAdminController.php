...
class ArticleAdminController extends BaseController
{
     ...
     */
    public function new(EntityManagerInterface $em, Request $request, UploadHelper $uploaderHelper)
    {
     ...
     */
    public function edit(Article $article, Request $request, EntityManagerInterface $em, UploadHelper $uploaderHelper)
    {
